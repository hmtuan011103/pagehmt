  ...
  <div class="group relative cursor-pointer">
    <div class="relative z-10 bg-[#1a1a1a]
      ...
      <div class="relative z-10">
        ...
        <!-- Gia đình -->
        <DynamicButton type="family" @click="navigateToMemory" />
      </div>
    </div>
  </div>
</template>
...
const getCurrentInstanceName = () => {
  return 'Family' // Hardcoded since setup doesn't have access to component's name directly
}
