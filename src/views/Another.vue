    ...
    <div class="group relative cursor-pointer">
      <div class="relative z-10 bg-[#1a1a1a]
        ...
        <div class="relative z-10">
          ...
          <!-- Kỉ niệm -->
          <DynamicButton type="other" @click="navigateToMemory" />
        </div>
      </div>
    </div>
</template>
...
onMounted(() => {
  breadcrumbsStore.setPages([
    { name: 'Kỉ niệm', href: '/another', current: false },
  ])
})
...
const getCurrentInstanceName = () => {
  return 'Another' // Hardcoded since setup doesn't have access to component's name directly
}
