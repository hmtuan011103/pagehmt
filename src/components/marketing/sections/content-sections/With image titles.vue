  ...
  <div class="overflow-hidden bg-white py-24 sm:py-32">
    <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
      <div class="max-w-4xl">
        ...
        <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">On a mission to empower remote teams</h1>
        <p class="mt-6 text-balance text-xl leading-8 text-gray-700">Aliquet nec orci mattis amet quisque ullamcorper neque, nibh sem. At arcu, sit dui mi, nibh dui, diam eget aliquam. Quisque id at vitae feugiat egestas.</p>
      </div>
      <section class="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
        <div class="lg:pr-8">
          <h2 class="text-pretty text-2xl font-semibold tracking-tight text-gray-900">Our mission</h2>
        ...
        <div class="max-lg:mt-16 lg:col-span-1">
          <p class="text-base font-semibold leading-7 text-gray-500">The numbers</p>
          ...
          <dl class="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
            <div class="flex flex-col gap-y-2 border-b border-dotted border-gray-200 pb-4">
              ...
              <dd class="order-first text-6xl font-semibold tracking-tight">$<span>150</span>M</dd>
            </div>
            <div class="flex flex-col gap-y-2 border-b border-dotted border-gray-200 pb-4">
              <dt class="text-sm/6 text-gray-600">Companies</dt>
              <dd class="order-first text-6xl font-semibold tracking-tight"><span>30</span>K</dd>
            </div>
            <div class="flex flex-col gap-y-2 max-sm:border-b max-sm:border-dotted max-sm:border-gray-200 max-sm:pb-4">
              ...
              <dd class="order-first text-6xl font-semibold tracking-tight"><span>1.5</span>M</dd>
            </div>
            <div class="flex flex-col gap-y-2">
              <dt class="text-sm/6 text-gray-600">Leads Generated</dt>
              <dd class="order-first text-6xl font-semibold tracking-tight"><span>200</span>M</dd>
            </div>
          </dl>
        </div>
      </section>
